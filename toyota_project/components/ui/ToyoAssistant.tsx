...
/**
 * ToyoAssistant - Unified AI Assistant
 *
 * Combines text chat and voice chat into a single tabbed interface.
 * - Chat Mode: Text-based conversation with streaming responses
 * - Voice Mode: Voice-based conversation using Web Speech APIs
 */
export function ToyoAssistant({ cars, originalQuery }: ToyoAssistantProps) {
  ...
  const sendChatMessage = async () => {
    ...
    try {
      // Include original description as first user message (API only, not shown in UI)
